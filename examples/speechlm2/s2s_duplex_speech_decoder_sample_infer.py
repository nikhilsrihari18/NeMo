...
class DuplexS2SSpeechDecoderSampleInference:
    ...
    def __init__(self, model_config_path: str, model_ckpt_path: str):
    ...
    def run_inference(self, audio_path: str = None, input_text: str = None):
        ...
        if input_text:
            ...
            print(f"Input signal lens: {input_signal_lens}")
...
def main():
    ...
    inference = DuplexS2SSpeechDecoderSampleInference(args.model_config_path, args.model_ckpt_path)
